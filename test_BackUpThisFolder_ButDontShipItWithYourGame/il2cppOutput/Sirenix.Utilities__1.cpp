...
IL_0036:
	{
		...
		bool L_11;
		L_11 = Int32_TryParse_mC928DE2FEC1C35ED5298BDDCA9868076E94B8A21(L_10, (&((UnityVersion_tE500D5149C91F4C210AEE2AC9E7C111631727802_StaticFields*)il2cpp_codegen_static_fields_for(UnityVersion_tE500D5149C91F4C210AEE2AC9E7C111631727802_il2cpp_TypeInfo_var))->___Major), NULL);
		if (L_11)
		{
			goto IL_007b;
		}
...
IL_007b:
	{
		...
		bool L_26;
		L_26 = Int32_TryParse_mC928DE2FEC1C35ED5298BDDCA9868076E94B8A21(L_25, (&((UnityVersion_tE500D5149C91F4C210AEE2AC9E7C111631727802_StaticFields*)il2cpp_codegen_static_fields_for(UnityVersion_tE500D5149C91F4C210AEE2AC9E7C111631727802_il2cpp_TypeInfo_var))->___Minor), NULL);
		if (L_26)
		{
			goto IL_00c0;
		}
...
IL_0009:
	...
	}
	{
		...
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_8, ((RuntimeMethod*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&UnsafeUtilities_StringFromBytes_m901CC2408D7DE1837080118E5A318EC486212110_RuntimeMethod_var)));
	}
...
IL_002c:
	{
		...
		String_t* L_10;
		L_10 = String_CreateString_mAA0705B41B390BDB42F67894B9B67C956814C71B(NULL, 0, L_9, NULL);
		V_2 = L_10;
	}
	{
...
IL_0013:
	...
	}
	{
		...
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_10, ((RuntimeMethod*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&UnsafeUtilities_StringToBytes_m8219223860FD6BCF526EE057082EC29B8F9CF894_RuntimeMethod_var)));
	}
